...
export default function EditProfile () {
 ...
 useEffect(() => {
  ...
  axios.get('http://iam.localhost/api/v1/users/Me', {
    headers: {
 ...
 return (
    <div className="edit-profile">
        ...
        <p className="email">
            ...
            <span contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleBlur(e, setPhonenumber)}>{phonenumber}</span>
        </p>
