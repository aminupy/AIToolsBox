    ...
    onDrop: async (acceptedFiles, rejectedFiles) => {
      ...
      if (rejectedFiles.length > 0) {
        ...
        try {
          ...
          setReceivedText(ocrResponse.data.text); // Set receivedText
          console.log(receivedText); // Log the value immediately after setting the state
        } catch (error) {
          console.error(error);
      ...
      <div className=" h-[1024px] overflow-hidden w-[1440px]">
        <div className="h-[1919px] -left-[266px] relative -top-[81px] w-[2009px]">
          ...
          <div className="bg-[#ffffff] h-[312px] md:left-[544px] left-[450px] absolute lg:top-[473px] top-[330px] rounded-[8px] w-[345px]">
            <div
              className="bg-[#ede7e3] top-[10px] left-[12px] rounded-[8px] h-[290px] absolute w-[321px]"
              {...getRootProps()}
            >
              <input {...getInputProps()} />
              ...
              <div className="h-[58px] left-[130px] absolute top-[115px] w-[62px]">
                <div className="bg-[#489fb5] rounded-[30px/29px] h-[58px] relative w-[60px]">
                  <div className="text-[#ede7e3] font-inter text-[32px] font-medium left-[11px] tracking-[0] leading-[normal] absolute text-center top-[10px] whitespace-nowrap w-[36px]">
                    +
                  </div>
                </div>
              </div>
          ...
          <div className="bg-[#ede7e3] rounded-[8px] h-[290px] xl:left-[1096px] lg:left-[962px] md:left-[557px] left-[462px] absolute lg:top-[484px] top-[691px] w-[321px]">
            {receivedText}
          </div>
          <div className="text-[#ede7e3] font-inter md:text-[60px] text-[50px] font-bold xl:left-[608px] lg:left-[500px] md:left-[400px] left-[330px] tracking-[0] leading-[normal] absolute text-center lg:top-[291px] top-[200px] whitespace-nowrap">
